...
var (
	...
	errInvalidContentPayload    = errors.New("INVALID_CONTENT_PAYLOAD")
)
...
func writeServiceError(statusCode func(int, string, string), err error) {
	...
	case errors.Is(err, errInvalidContentPayload):
		statusCode(http.StatusBadRequest, "INVALID_CONTENT_PAYLOAD", "invalid LMS content payload")
