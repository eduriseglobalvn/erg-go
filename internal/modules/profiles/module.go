...
import (
	...
	profilescontroller "erg.ninja/internal/modules/profiles/api/controller"
	profilesservice "erg.ninja/internal/modules/profiles/application/service"
	"erg.ninja/pkg/auth"
	"erg.ninja/pkg/cache"
...
func (m *Module) Setup() error {
	...
	if m.deps.Cfg != nil && m.deps.Cfg.Lifecycle.ProfileBackfillOnStartup {
