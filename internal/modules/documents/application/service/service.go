...
func (s *Service) GetFileBuffer(ctx context.Context, r2URL string) ([]byte, string, error) {
	if s.r2 == nil {
		return nil, "", fmt.Errorf("documents.service.get_file_buffer: r2 storage not configured")
	}
	return s.r2.GetFileBuffer(ctx, r2URL)
}
