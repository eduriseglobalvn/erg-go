...
import (
	...
	authentities "erg.ninja/internal/modules/auth/entities"
	"erg.ninja/internal/modules/users/entities"
)
...
func NewActivityResponse(a *entities.UserActivity) ActivityResponse {
	r := ActivityResponse{
		ID:          a.ID.Hex(),
		UserID:      a.UserID.Hex(),
