...
func SeedService(s *Service) {
	...
	s.programs = []ProgramDTO{
		...
		{ID: "program-ic3", Slug: "ic3-digital-literacy", Name: "IC3 Digital Literacy", ShortName: "IC3", SubjectIDs: []string{"ic3", "tin-hoc"}, GradeIDs: []string{"6", "7", "8", "9", "10", "11", "12"}, Description: "Hoc lieu Computing Fundamentals, Key Applications va Living Online."},
	...
	s.bookSeries = []TaxonomyOptionDTO{
		...
		{ID: "ic3-gs6", Label: "IC3 GS6", Slug: "ic3-gs6", SubjectID: "ic3", LevelIDs: []string{"6", "7", "8", "9", "10", "11", "12"}, Status: "active", SortOrder: 3},
	}
	...
	seedSimpleResource(s, now, "res-ic3-gs6-living-online", "ic3-gs6-living-online", "IC3 GS6 - Living Online", "Computing fundamentals practice", "ic3-digital-literacy", "ic3", "6", "lecture-bank", AssetFileTypePPTX)
	...
	seedSimpleResource(s, now, "res-ic3-cf-quiz", "ic3-cf-quiz", "IC3 Computing Fundamentals - Quiz", "Cau hoi on tap theo objective", "ic3-digital-literacy", "ic3", "6", "quiz-bank", AssetFileTypeQuiz)
