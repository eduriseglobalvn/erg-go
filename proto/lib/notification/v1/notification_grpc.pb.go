...
const (
	NotificationService_Send_FullMethodName              = "/erg.ninja.lib.notification.v1.NotificationService/Send"
	NotificationService_Get_FullMethodName               = "/erg.ninja.lib.notification.v1.NotificationService/Get"
	NotificationService_List_FullMethodName              = "/erg.ninja.lib.notification.v1.NotificationService/List"
	NotificationService_Cancel_FullMethodName            = "/erg.ninja.lib.notification.v1.NotificationService/Cancel"
	NotificationService_GetPreferences_FullMethodName    = "/erg.ninja.lib.notification.v1.NotificationService/GetPreferences"
	NotificationService_UpdatePreferences_FullMethodName = "/erg.ninja.lib.notification.v1.NotificationService/UpdatePreferences"
	NotificationService_ListDigests_FullMethodName       = "/erg.ninja.lib.notification.v1.NotificationService/ListDigests"
	NotificationService_GetDeliveryLog_FullMethodName    = "/erg.ninja.lib.notification.v1.NotificationService/GetDeliveryLog"
	NotificationService_SendBulk_FullMethodName          = "/erg.ninja.lib.notification.v1.NotificationService/SendBulk"
)
...
type NotificationServiceClient interface {
	...
	Cancel(ctx context.Context, in *CancelNotificationRequest, opts ...grpc.CallOption) (*CancelNotificationResponse, error)
	...
	SendBulk(ctx context.Context, in *SendBulkRequest, opts ...grpc.CallOption) (*SendBulkResponse, error)
}
...
func (c *notificationServiceClient) Cancel(ctx context.Context, in *CancelNotificationRequest, opts ...grpc.CallOption) (*CancelNotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *notificationServiceClient) ListDigests(ctx context.Context, in *ListDigestsRequest, opts ...grpc.CallOption) (*ListDigestsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListDigestsResponse)
	err := c.cc.Invoke(ctx, NotificationService_ListDigests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) GetDeliveryLog(ctx context.Context, in *GetDeliveryLogRequest, opts ...grpc.CallOption) (*GetDeliveryLogResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDeliveryLogResponse)
	err := c.cc.Invoke(ctx, NotificationService_GetDeliveryLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) SendBulk(ctx context.Context, in *SendBulkRequest, opts ...grpc.CallOption) (*SendBulkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendBulkResponse)
...
type NotificationServiceServer interface {
	...
	// Cancel a pending notification
	Cancel(context.Context, *CancelNotificationRequest) (*CancelNotificationResponse, error)
	// Preference management
	...
	// Bulk send from template
	SendBulk(context.Context, *SendBulkRequest) (*SendBulkResponse, error)
...
func (UnimplementedNotificationServiceServer) Cancel(context.Context, *CancelNotificationRequest) (*CancelNotificationResponse, error) {
...
func (UnimplementedNotificationServiceServer) ListDigests(context.Context, *ListDigestsRequest) (*ListDigestsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDigests not implemented")
}
func (UnimplementedNotificationServiceServer) GetDeliveryLog(context.Context, *GetDeliveryLogRequest) (*GetDeliveryLogResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDeliveryLog not implemented")
}
func (UnimplementedNotificationServiceServer) SendBulk(context.Context, *SendBulkRequest) (*SendBulkResponse, error) {
...
func _NotificationService_Cancel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).Cancel(ctx, req.(*CancelNotificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _NotificationService_ListDigests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDigestsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServiceServer).ListDigests(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_ListDigests_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).ListDigests(ctx, req.(*ListDigestsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _NotificationService_GetDeliveryLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDeliveryLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServiceServer).GetDeliveryLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_GetDeliveryLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetDeliveryLog(ctx, req.(*GetDeliveryLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _NotificationService_SendBulk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendBulk(ctx, req.(*SendBulkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "erg.ninja.lib.notification.v1.NotificationService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NotificationService_ListDigests_Handler,
		},
		{
			MethodName: "GetDeliveryLog",
			Handler:    _NotificationService_GetDeliveryLog_Handler,
		},
		{
			MethodName: "SendBulk",
	...
	Metadata: "proto/lib/notification/v1/notification.proto",
}
